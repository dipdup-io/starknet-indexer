...
require (
	github.com/dipdup-io/starknet-go-api v0.0.0-20230821102124-e1e540059e1b
	github.com/dipdup-io/workerpool v0.0.3
	github.com/dipdup-net/go-lib v0.3.2
...
require (
	...
	github.com/mattn/go-sqlite3 v1.14.17 // indirect; indirect108.9055996755782866
