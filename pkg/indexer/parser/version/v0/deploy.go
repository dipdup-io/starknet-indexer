...
// ParseDeploy -
func (parser Parser) ParseDeploy(ctx context.Context, raw *data.Deploy, block storage.Block, receiverTx receiver.Transaction, trace sequencer.Trace) (storage.Deploy, *storage.Fee, error) {
	tx := storage.Deploy{
